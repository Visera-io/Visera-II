...
export module Visera.Game.Render.Sprite;
...
namespace Visera
{
    ...
    public:
        ...
        {
            struct FBackgroundPushConstant
            {
                Float Time{0.0f};
                Float Alpha{1.0f};
                Float OffsetX{0.0f};
            ...
            static FBackgroundPushConstant BGPC{};
    ...
    public:
        FSpriteRenderer()
        {
            ...
            PSO.FragmentShader = GRHI->CreateShader( ERHIShaderStages::Fragment,
                GAssetHub->LoadShader(FPath("Sprite.slang"), "FragmentBackgroundMain", EAssetSource::Engine)
                ->GetSPIRVCode());
