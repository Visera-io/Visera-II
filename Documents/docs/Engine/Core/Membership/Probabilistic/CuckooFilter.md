# Core.Membership.Probabilistic.CuckooFilter (FCuckooFilter)
...
- **Module**: `Visera.Core.Membership.Probabilistic.CuckooFilter` (exported via `Visera.Core.Membership`).
...
- [Probabilistic](index.md) — Parent module
- [Membership](../index.md) — Membership overview
