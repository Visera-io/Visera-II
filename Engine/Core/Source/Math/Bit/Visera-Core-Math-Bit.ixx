...
export namespace Visera
{
    namespace Math
    {
        ...
        template<Concepts::UnsignedIntegral NumT> constexpr Int32
        ...
        template<Concepts::UnsignedIntegral NumT> constexpr bool
        HasSingleBit(NumT I_Number) noexcept { return std::has_single_bit(I_Number); }

        template<Concepts::UnsignedIntegral NumT> constexpr NumT
