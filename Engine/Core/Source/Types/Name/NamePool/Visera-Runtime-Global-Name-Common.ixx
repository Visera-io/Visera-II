...
export module Visera.Core.Types.Name.NamePool:Common;
...
export namespace Visera
{
	...
	*/
	...
	class VISERA_CORE_API FNameHash
	{
	...
	class VISERA_CORE_API FNameEntry
	{
		friend class FNamePool;
	...
	class VISERA_CORE_API FNameEntryHandle
	{
		friend class FNamePool;
	...
	class VISERA_CORE_API FNameToken
	{
		friend class FNamePool;
