set(VISERA_API_SOURCE_DIR   "${PROJECT_SOURCE_DIR}/Source"  )
set(VISERA_API_EXTERNAL_DIR "${PROJECT_SOURCE_DIR}/External")
set(VISERA_API_INCLUDE_DIR  "${PROJECT_SOURCE_DIR}/Include" )
set(VISERA_API_SCRIPTS_DIR  "${PROJECT_SOURCE_DIR}/Scripts" )
