...
{
    enum class EVulkanQueueFamily : UInt8
    {
        Graphics = static_cast<UInt8>(vk::QueueFlagBits::eGraphics),
        Transfer = static_cast<UInt8>(vk::QueueFlagBits::eTransfer),
    ...
    enum class EVulkanGraphicsStage : UInt32
    {
        ...
        IndexInput              = static_cast<UInt32>(vk::PipelineStageFlagBits2::eIndexInput),
        VertexAttributeInput    = static_cast<UInt32>(vk::PipelineStageFlagBits2::eVertexAttributeInput),

        PreRasterizationShaders = static_cast<UInt32>(vk::PipelineStageFlagBits2::ePreRasterizationShaders),

        VertexShader            = static_cast<UInt32>(vk::PipelineStageFlagBits2::eVertexShader),
        TessellationControl     = static_cast<UInt32>(vk::PipelineStageFlagBits2::eTessellationControlShader),
        TessellationEvaluation  = static_cast<UInt32>(vk::PipelineStageFlagBits2::eTessellationEvaluationShader),
        GeometryShader          = static_cast<UInt32>(vk::PipelineStageFlagBits2::eGeometryShader),
        FragmentShader          = static_cast<UInt32>(vk::PipelineStageFlagBits2::eFragmentShader),

        EarlyFragmentTests      = static_cast<UInt32>(vk::PipelineStageFlagBits2::eEarlyFragmentTests),
        LateFragmentTests       = static_cast<UInt32>(vk::PipelineStageFlagBits2::eLateFragmentTests),

        ColorAttachmentOutput   = static_cast<UInt32>(vk::PipelineStageFlagBits2::eColorAttachmentOutput),

        AllGraphics             = static_cast<UInt32>(vk::PipelineStageFlagBits2::eAllGraphics),
        AllCommands             = static_cast<UInt32>(vk::PipelineStageFlagBits2::eAllCommands),
    };
    VISERA_MAKE_FLAGS(EVulkanGraphicsStage);
    [[nodiscard]] constexpr vk::PipelineStageFlagBits2
    TypeCast(EVulkanGraphicsStage I_Stage) { return static_cast<vk::PipelineStageFlagBits2>(I_Stage); }


    enum class EVulkanTransferStage : UInt32
    {
        None        = static_cast<UInt32>(vk::PipelineStageFlagBits2::eNone),
        ...
        AllTransfer = static_cast<UInt32>(vk::PipelineStageFlagBits2::eAllTransfer),

        // Fine-grained transfer ops (VK_KHR_synchronization2)
        Copy        = static_cast<UInt32>(vk::PipelineStageFlagBits2::eCopy),
        Resolve     = static_cast<UInt32>(vk::PipelineStageFlagBits2::eResolve),
        Blit        = static_cast<UInt32>(vk::PipelineStageFlagBits2::eBlit),
        Clear       = static_cast<UInt32>(vk::PipelineStageFlagBits2::eClear),

        AllCommands = static_cast<UInt32>(vk::PipelineStageFlagBits2::eAllCommands),
    };
    VISERA_MAKE_FLAGS(EVulkanTransferStage);
    [[nodiscard]] constexpr vk::PipelineStageFlagBits2
    TypeCast(EVulkanTransferStage I_Stage) { return static_cast<vk::PipelineStageFlagBits2>(I_Stage); }

    enum class EVulkanComputeStage : UInt32
    {
        None        = static_cast<UInt32>(vk::PipelineStageFlagBits2::eNone),
        ...
        ComputeShader = static_cast<UInt32>(vk::PipelineStageFlagBits2::eComputeShader),
    ...
    VISERA_MAKE_FLAGS(EVulkanComputeStage);
    [[nodiscard]] constexpr vk::PipelineStageFlagBits2
    TypeCast(EVulkanComputeStage I_Stage) { return static_cast<vk::PipelineStageFlagBits2>(I_Stage); }
}
