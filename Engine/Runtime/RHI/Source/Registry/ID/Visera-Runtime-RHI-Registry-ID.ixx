...
export module Visera.Runtime.RHI.Registry.ID;
...
{
    class VISERA_RUNTIME_API FRHIResourceID : public FHandle
    {
    public:
    ...
    struct VISERA_RUNTIME_API FRHITextureID : FRHIResourceID
    {
    ...
    struct VISERA_RUNTIME_API FRHIBufferID : FRHIResourceID
    {
    ...
    struct VISERA_RUNTIME_API FRHISamplerID : FRHIResourceID
    {
    ...
    struct VISERA_RUNTIME_API FRHIShaderID : FRHIResourceID
    {
    ...
    struct VISERA_RUNTIME_API FRHIRenderPassID : FRHIResourceID
    {
    ...
    struct VISERA_RUNTIME_API FRHIDescriptorSetLayoutID : FRHIResourceID
    {
    ...
    struct VISERA_RUNTIME_API FRHIDescriptorSetID : FRHIResourceID
    {
