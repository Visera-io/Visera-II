...
#undef VISERA_CORE_API
  ...
  #if defined(VISERA_GLOBAL_BUILD_STATIC)
    #define VISERA_GLOBAL_API
  #elif defined(VISERA_GLOBAL_BUILD_SHARED) || defined(VISERA_MONOLITHIC_MODE)
    #define VISERA_GLOBAL_API __declspec(dllexport)
  #else
    #define VISERA_GLOBAL_API __declspec(dllimport)
  #endif
#else
  #define VISERA_GLOBAL_API __attribute__((visibility("default")))
#endif
