...
export namespace Visera
{
    ...
    private:
        ...
        TArray<TArray<FAutoBarrier>> PerNodeBarriers;
                            ...
                            ERHIImageLayout I_InitialLayout)
    {
        ...
        auto ID = RegisterExternalTexture(I_Imported, I_CreateInfo, I_InitialLayout);
        if (ID.IsValid()) { NamedTextures.Insert(std::move(I_Name), ID); }
        return ID;
    }
