set(VISERA_ASSETS_SOURCE_DIR   "${PROJECT_SOURCE_DIR}/Source"   CACHE STRING "")
set(VISERA_ASSETS_EXTERNAL_DIR "${PROJECT_SOURCE_DIR}/External" CACHE STRING "")
set(VISERA_ASSETS_INCLUDE_DIR  "${PROJECT_SOURCE_DIR}/Include"  CACHE STRING "")
set(VISERA_ASSETS_SCRIPTS_DIR  "${PROJECT_SOURCE_DIR}/Scripts"  CACHE STRING "")
...
if(VISERA_MONOLITHIC_MODE)
   ...
   add_custom_command(
    ...
    target_link_libraries(${VISERA_ASSETS} PRIVATE Visera::Global)
