...
#endif
export module Visera.Runtime.Debug.UI.ImGui;
...
{
    export class VISERA_RUNTIME_API FImGui
    {
    public:
        struct VISERA_RUNTIME_API FWindow
        {
            Bool Status = False;
            FWindow() = delete;
            VISERA_FORCEINLINE
        ...
        [[nodiscard]] VISERA_FORCEINLINE FWindow
