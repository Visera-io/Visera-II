...
export module Visera.Runtime.Physics;
#define VISERA_MODULE_NAME "Runtime.Physics"
export import Visera.Runtime.Physics.Common;
       import Visera.Runtime.Physics.RigidBody;
       import Visera.Core.Global;
       import Visera.Runtime.Log;

namespace Visera
{
    export class VISERA_RUNTIME_API FPhysics : public IGlobalSingleton<FPhysics>
    {
    public:
    ...
    export inline VISERA_RUNTIME_API TUniquePtr<FPhysics>
