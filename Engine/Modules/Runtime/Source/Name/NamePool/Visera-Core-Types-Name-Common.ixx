...
export module Visera.Runtime.Name.NamePool:Common;
...
export namespace Visera
{
	...
	*/
	...
	class VISERA_RUNTIME_API FNameHash
	{
	...
	class VISERA_RUNTIME_API FNameEntry
	{
		friend class FNamePool;
	...
	class VISERA_RUNTIME_API FNameEntryHandle
	{
		friend class FNamePool;
	...
	class VISERA_RUNTIME_API FNameToken
	{
		friend class FNamePool;
